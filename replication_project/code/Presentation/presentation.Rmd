...
- Intuitively, the empirical strategy tests if outcomes of interest track this same pattern. The effects of EV on policy outcomes are thus identified only from variation coming from the interaction of a cross-sectional variable (share of voters above the cutoff) with the timing of elections.

- Focus on health care spending, since it is an area that disproportionately affects the less educated. Poorer Brazilians rely mostly on a public-funded system for health care services, while richer voters are more likely to use private services. The less educated have thus relatively stronger preferences for public health services, and a shift in spending toward health care can be interpreted as redistribution to the poor.

- Prenatal visits and birthweight.

- The main identification assumption behind this empirical approach is that
no omitted variable affecting the outcomes follows the particular pattern of
electronic voting’s introduction.
